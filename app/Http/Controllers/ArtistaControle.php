    ...
    function listar() {
       ...
       function excluir($id) {
        ...
        try {
          ...
          return redirect('artista/listar')->with(['msg' => 'Artista não pode ser excluído']);
        }
       ...
       function relatorio() {
        ...
        $pdf = Pdf::loadView('relatorioArtistas', compact('artistas'));
        return $pdf->download('artistas.pdf');
      }
}
